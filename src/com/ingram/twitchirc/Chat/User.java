...
public class User
{
	 ...
	 */
	public final void hostthisUser(Channel channel, com.ingram.twitchirc.Core.TwitchBot bot)
	{
		channel.host(com.ingram.twitchirc.Chat.Channel.getChannel(user, bot));;
	}
